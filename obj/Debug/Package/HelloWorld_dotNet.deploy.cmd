...
set _DeploySetParametersFile=%RootPath%HelloWorld_dotNet.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%HelloWorld_dotNet.zip" (
echo "%RootPath%HelloWorld_dotNet.zip" does not exist. 
...
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%HelloWorld_dotNet.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%HelloWorld_dotNet.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
) else (
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%HelloWorld_dotNet.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%HelloWorld_dotNet.SetParameters.xml" %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%HelloWorld_dotNet.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%HelloWorld_dotNet.SetParameters.xml" %_MsDeployAdditionalFlags%
)
goto :eof
...
:usage
echo =========================================================
if not exist "%RootPath%HelloWorld_dotNet.deploy-readme.txt" (
...
start notepad "%RootPath%HelloWorld_dotNet.deploy-readme.txt"
)
echo =========================================================
goto :eof
